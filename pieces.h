...
extern void setWhiteLeftRook(int value);

extern void setBlackLeftRook(int value);
extern void setBlackRightRook(int value);
extern void setWhiteLeftRook(int value);
extern void setWhiteRightRook(int value);
extern void setBlackKing(int value);
extern void setWhiteKing(int value);
extern void castle(unsigned char key);
